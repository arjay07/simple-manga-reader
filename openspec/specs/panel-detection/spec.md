...
Server-side manga panel detection using ML (YOLO) models, providing APIs to detect panel bounding boxes, classify page types, and extract page images from PDF volumes.
## Requirements
